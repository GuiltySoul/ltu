...
# 第3步：R網路抓取Yahoo中宏盛股價資料

```{r}
stock <- getSymbols("2534.TW", auto.assign = FALSE)
...
#包含每天開盤價(2534.tw.Open)、最高價(2534.tw.High)、最低價(2534.tw.Low)、收盤價(2534.tw.Close)、成交量(2534.tw.Volume)、(還原權值)2534.tw.Adjusted。
```
