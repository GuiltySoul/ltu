...
# 第3步：R網路抓取Yahoo中太子建設股價資料

```{r}
stock <- getSymbols("2511.TW", auto.assign = FALSE)
...
#包含每天開盤價(2511.tw.Open)、最高價(2511.tw.High)、最低價(2511.tw.Low)、收盤價(2511.tw.Close)、成交量(2511.tw.Volume)、(還原權值)2511.tw.Adjusted。
```
